#' Demo SLT
#'
#' This function launches a demo for the SLT.
#'
...
#' @export
#'
SLT_demo <- function(num_items = 3L,
  ...
  psychTestR::make_test(
    elts,
    opt = psychTestR::test_options(title = "Melodie-Unterscheidungstest",
                                   admin_password = admin_password,
                                   researcher_email = researcher_email,
                                   demo = TRUE,
                                   languages = c("de", "de_f", "en")))
}
